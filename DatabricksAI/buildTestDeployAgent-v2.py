...
# DBTITLE 1,Check the volumes
# MAGIC %fs ls /Volumes/sample_catalog/sample_database/whl_files/

# COMMAND ----------

# MAGIC %pip install /Volumes/sample_catalog/sample_database/whl_files/*
...
for event in AGENT.predict_stream(
    {"messages": [{"role": "user", "content": "what is salary of dave"}]}
):
    print(event, "-----------\n")
...
model_name = "data_analysis_model_v2"
